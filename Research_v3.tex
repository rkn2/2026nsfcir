...
\item \textit{Technical KPIs} (Subtask~1.5):
  ...
  ranking-stability threshold from preliminary sensitivity analysis,
  $\sim$0.4 log-units / $\sim$70\,h RMSE, below which the top-20
