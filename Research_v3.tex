...
uncertainty to a decision-adequate damage estimate. The second is \textbf{physical}:
the CPS couples to its environment on both ends, sensing physical flood signatures
