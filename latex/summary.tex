...
The loop closes at three timescales---pre-storm staging from NOAA forecasts,
post-event updating of priors and error models, and long-term retrofit feedback
through drainage and fragility updates---with human decisions as the actuators,
