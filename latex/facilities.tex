...
\item \textbf{InSAR, Geodesy, \& Geohazards (IGG) Lab at Penn State:}
The InSAR Geodesy \& Geohazards Laboratory (IGG) Lab managed by Co-PI Wauthier is a computational laboratory with five Unix-based computers and one Windows laptop configured for image processing, geospatial analysis, and scientific computing. Wauthier's personal workstation is a Mac Pro with a 3.7 GHz Quad-Core Intel Xeon E5 processor and 32 GB of 1866 MHz DDR3 memory. The IGG Lab also has access to Penn State's high-performance computing (HPC) system, Roar Collab. Roar Collab provides SAR data processing software (GAMMA, ISCE, and GMTSAR), InSAR time-series analysis tools (StaMPS/MTI and MintPy), and scientific computing, modeling, and geospatial analysis software, including Python, MATLAB, COMSOL, Abaqus, R, and GIS applications. These resources directly support the remote sensing-based flood analyses in Subtasks~1.1 and~1.3.
